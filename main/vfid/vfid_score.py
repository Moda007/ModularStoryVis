...
def calculate_activation_statistics(vids, model, batch_size=32, dims=512, cuda=False, normalize=False, verbose=0, is_ref=False): # Moda: match "fid/vfid_score.py"
...
def calculate_frechet_distance(mu1, sigma1, mu2, sigma2, eps=1e-6): # Moda: match "fid/vfid_score.py"
...
def fid_score(r_imgs, g_imgs, batch_size=50, dims=512, cuda=False, normalize=False, r_cache='reference_fid', verbose=0): # Moda: match "fid/vfid_score.py"
    model = R2Plus1D()
	# cache real dataset
