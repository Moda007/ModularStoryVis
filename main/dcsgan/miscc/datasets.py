...
import numpy as np
import pandas as pd
import glob # Moda: for CP-CSV additional classes
...
class FolderStoryDataset(data.Dataset): # Moda: additional class for CP-CSV
...
class FolderImageDataset(data.Dataset): # Moda: additional class for CP-CSV
    def __init__(self, data_dir, transform):
        self.data_dir = data_dir
