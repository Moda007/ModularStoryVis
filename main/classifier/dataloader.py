...
class ImageDataset(torch.utils.data.Dataset): # Moda: only for DuCo
...
class StoryImageDataset(torch.utils.data.Dataset): # Moda: only for DuCo
    def __init__(self, img_folder, im_input_size, out_img_folder = '/ssd-playpen/home/adyasha/projects/StoryGAN/pororo_code_mod/output/pororo_both_stageI_r1.0/Test/images-epoch-110/', mode='train', video_len = 5):
        self.lengths = []
        self.followings = []
        self.images = []
        self.img_dataset = ImageFolder(img_folder)
