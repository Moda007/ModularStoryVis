...
__C.CASCADE_MODEL = True # Moda: for Caascade, from CP-CSV
...
__C.VIS_COUNT = 64
 ...
 # Moda: for Cascade & Segmentation, from CP-CSV
__C.USE_SEQ_CONSISTENCY = False
__C.CONSISTENCY_RATIO = 1.0
__C.SEGMENT_LEARNING = True
__C.SEGMENT_RATIO = 1.0
__C.IMAGE_RATIO = 5.0
...
__C.LABEL_NUM = 10 # Moda: = 9 in CP-CSV
# Training options
__C.TRAIN = edict()
__C.TRAIN.FLAG = True
...
__C.TRAIN.NET_E = ''
__C.TRAIN.SEGMENT_NAME = 'img_segment' # Moda: for Segmentation, from CP-CSV
...
__C.GAN.Z_DIM = 100
__C.GAN.DF_DIM = 64 # Moda: = 124 in CP-CSV
__C.GAN.GF_DIM = 128 # Moda: = 256 in CP-CSV
__C.GAN.GF_SEG_DIM = 1024 # Moda: for Segmentation, from CP-CSV
__C.GAN.R_NUM = 4

__C.TEXT = edict()
__C.TEXT.DIMENSION = 128 # Moda: = 356 in CP-CSV
